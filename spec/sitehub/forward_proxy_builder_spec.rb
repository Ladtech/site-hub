  ...
  describe ForwardProxyBuilder do
      ...
      context 'split supplied' do
        ...
        context 'block not supplied' do
          it 'stores a split for the version' do
            ...
            expected_proxy = {CookieMiddleware.new(ForwardProxy.new(url: :url), id: :label, sitehub_cookie_name: :cookie_name) => 50}
    ...
    describe 'route' do
      it 'accepts a rule' do
        ...
        expected_route = CookieMiddleware.new(ForwardProxy.new(url: :url), sitehub_cookie_name: :cookie_name, id: :current, rule: :rule)
